...
| T-010 | CrawlerSource 추상 베이스 (robots.txt) | REQ-007/008 | T-001~009 | cloud-control-plane/src/app/services/crawler/base.py | pending |
| T-011 | 토큰버킷 rate limiter (1 req/s/source) | REQ-009 | T-010 | cloud-control-plane/src/app/core/ratelimit.py | pending |
| T-012 | 지수 백오프 재시도 3회 + 실패 격리 | REQ-005/006 | T-010 | services/crawler/base.py (MODIFY) | pending |
| T-013 | SHA-256 dedup 서비스 | REQ-003/003b | T-005 | cloud-control-plane/src/app/services/dedup.py | pending |
| T-014 | Blob 업로드 서비스 + 경로 규약 | REQ-001/002 | T-002 | cloud-control-plane/src/app/services/storage.py | pending |
| T-015 | FDA source 구현 | REQ-001 | T-010~014 | cloud-control-plane/src/app/services/crawler/fda.py | pending |
| T-016 | orchestrator (소스 순회, 실패 격리, INSERT) | REQ-001/004/006 | T-015 | cloud-control-plane/src/app/services/orchestrator.py | pending |
| T-017 | 수동 트리거 API | REQ-011/012 | T-016 | cloud-control-plane/src/app/routers/crawl.py, schemas/crawl.py | pending |
